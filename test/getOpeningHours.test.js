...
describe('Testes da função getOpeningHours', () => {
  it('Retorna o objeto correto quando não é passado nenhum argumento', () => {
  ...
  it('Retorna a string "The zoo is closed" quando são passados Monday e 09:00-AM como parâmetros', () => {
    expect(getOpeningHours('Monday', '09:00-AM')).toBe('The zoo is closed');
  });
  it('Retorna a string "The zoo is open" quando são passados Tuesday e 09:00-AM como parâmetros', () => {
    expect(getOpeningHours('Tuesday', '09:00-AM')).toBe('The zoo is open');
  });
  it('Retorna a string "The zoo is closed" quando são passados Wednesday e 09:00-PM como parâmetros', () => {
